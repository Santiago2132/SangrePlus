...
export default class NuevaCitaModel {
    ...
    public async procesarCita(citaData: Record<string, string | undefined>): Promise<string> {
        ...
        const citaDePrueba: CitaInterface = {
    ...
    public async agregarNuevaCita(updatedCita: CitaInterface):Promise<boolean> {
